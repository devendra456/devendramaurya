class DataValues {
  // About App
  static const String appName = 'Devendra';
  static const String appNameLong = 'devendramaurya.web.app';
  static const String appDeveloper = 'Devendra Maurya';
  static const String appPackage = 'com.portfolio.devendramaurya';
  static const String appVersion = '3.0.0';
  static const String appBuildNumber = '1';

  // External links
  static Uri githubURL = Uri.parse('https://github.com/devendra456');
  static Uri linkedinURL =
      Uri.parse('https://www.linkedin.com/in/devendra-maurya-b639261aa/');
  static Uri twitterURL = Uri.parse('https://x.com/Devendra7897430');
  static Uri bssitmURL = Uri.parse(educationOrg1URL);
  ...
  static const String headerName = 'Devendra Maurya';
  static const String headerTitle = 'Student | Developer | Freelancer';
  ...
  static const String aboutMeDescription =
      'I am a passionate and driven BTech graduate with 4 years of professional experience in hybrid mobile application development. Over the course of my career, '
      'I have successfully contributed to the development and deployment of around 30 applications, '
      'spanning both Android native and hybrid platforms. My work demonstrates a deep understanding of mobile technologies and a commitment to delivering high-quality user experiences.';
  static const String aboutMeBiographyTitle = 'Biography';
  static const String aboutMeBiographyDescription =
      "With my full-time roles, I have collaborated with freelance clients, translating their visions into functional and successful mobile applications. "
      "My ability to understand client needs, coupled with my technical expertise, ensures that I consistently deliver projects on time and exceed expectations.\n\nWith a strong foundation in coding, problem-solving, and project management, "
      "I am always eager to embrace new challenges and stay updated with emerging trends in mobile development. My ultimate goal is to create impactful applications that solve real-world problems and enhance the lives of users.";
  ...
  static const String aboutMeVolunteerTitle = 'Freelancer';
  static const String aboutMeVolunteerDescription =
      'I am a skilled freelance mobile application developer with expertise in creating user-friendly Android native and hybrid apps. With extensive experience in developing and delivering high-quality applications, they have successfully completed numerous projects for diverse clients. Passionate about crafting innovative solutions that meet client needs and industry standards.';
  ...
  static const String educationOrg2Course1Name =
      'Rajkiya Polytechnic Premdhar Patti Raniganj Pratapgarh Uttar Pradesh';
  ...
  static const String educationOrg2Course2Name =
      'Operating System, Data Structure using C, Java, Electrical & Electronics Basics';
  static const String educationOrg2Course2Grade =
      'Second position award on 78.49%';
  ...
  static const String experienceOrg1Title =
      'RV Solution Pvt. Ltd. Noida Uttar Pradesh';
  ...
  static const String experienceOrg2Title =
      'Skyview Smart Solutions Pvt. Ltd. Lucknow Uttar Pradesh';
  ...
  static const String experienceOrg3Years = 'May 2025 - Present';
...
static final Uri project1iOSURL =
  ...
  static const String contactEmail = 'devendramaurya456@gmail.com';

  // Footer
  static String copyright =
      "Copyright ©${DateTime.now().year} $appDeveloper. All Rights Reserved.";
