        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: ContainerCard(context: context).type5(
                    image: 'aktu_logo',
                    ...
                    message: DataValues.educationOrg1URL.toString(),
                    url: DataValues.bssitmURL,
                  ),
                ),
                ...
                Expanded(
                  child: ContainerCard(context: context).type5(
                    ...
                    message: DataValues.educationOrg2URL.toString(),
                    url: DataValues.diplomaURL,
                  ),
                ),
              ],
            ),
